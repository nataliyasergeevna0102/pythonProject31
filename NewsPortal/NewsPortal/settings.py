...
SECRET_KEY = 'django-insecure-&gb9w6iuzh)u=7d%z_vq7!ls*)=1mhp!$h1sqnp4(b4dvts!lk'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'error': {
            'format': '%(asctime)s %(levelname)s %(module)s %(pathname)s %(exc info)s %(message)s',
        },
    },
    'filters': {
        'require_debug_true': {
